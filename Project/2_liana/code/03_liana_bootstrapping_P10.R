...
head(data@meta.data)
p10 <- subset(data, sample == "P10")
table(p10$predicted.subclass)
...
saveRDS(LIANA_bootstrap, file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/LIANA_bootstrap.rds")
LIANA_bootstrap <- readRDS(file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/LIANA_bootstrap.rds")
...
# SAVING 
saveRDS(Lamp5_Sst_bootstrap_agg, file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Lamp5_Sst_bootstrap_agg.rds")
saveRDS(Lamp5_Pvalb_bootstrap_agg, file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Lamp5_Pvalb_bootstrap_agg.rds")
#saveRDS(Lamp5_Vip_bootstrap_agg, file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Lamp5_Vip_bootstrap_agg.rds") ### NEED TO CHANGE
saveRDS(Pvalb_Sst_bootstrap_agg, file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Pvalb_Sst_bootstrap_agg.rds")
saveRDS(Pvalb_Vip_bootstrap_agg, file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Pvalb_Vip_bootstrap_agg.rds")
saveRDS(Vip_Sst_bootstrap_agg, file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Vip_Sst_bootstrap_agg.rds")

# READING 
Lamp5_Sst_bootstrap_agg <- readRDS(file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Lamp5_Sst_bootstrap_agg.rds")
Lamp5_Pvalb_bootstrap_agg <- readRDS( file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Lamp5_Pvalb_bootstrap_agg.rds")
#Lamp5_Vip_bootstrap_agg <- readRDS(file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Lamp5_Vip_bootstrap_agg.rds") ### NEED TO CHANGE
Pvalb_Sst_bootstrap_agg <-readRDS( file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Pvalb_Sst_bootstrap_agg.rds")
Pvalb_Vip_bootstrap_agg <-readRDS( file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Pvalb_Vip_bootstrap_agg.rds")
Vip_Sst_bootstrap_agg <-readRDS( file = "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/Vip_Sst_bootstrap_agg.rds")
...
pdf("1_all_interactions_density.pdf")
# ploting and checking desnity
all %>%
  ggplot(aes(x=percentage)) +
  geom_density(fill="indianred", color="#e9ecef", alpha=0.8) +
...
#rrobust_ViptoLamp5_vecfilt <- subset(robust_ViptoLamp5, subset = robust_ViptoLamp5$percentage >= 75)
...
#robust_ViptoLamp5_agg <- keep_specific_inter(Lamp5_Vip_bootstrap_agg_filt, rrobust_ViptoLamp5_vecfilt$interactions) 
...
## 12 Plotting  -------------------------------------------------------------------------------------------------
pdf("2_heatmaps_P10.pdf")
robust_all <- rbind(robust_Lamp5toSst_agg_df,robust_Lamp5toPvalb_agg_df,robust_PvalbtoSst_agg_df,robust_PvalbtoVip_agg_df,robust_ViptoSst_agg_df,robust_SsttoLamp5_agg_df,robust_PvalbtoLamp5_agg_df,robust_SsttoPvalb_agg_df,robust_ViptoPvalb_agg_df,robust_SsttoVip_agg_df)
...
## save as csv
write.csv(robust_all_df, "/ibex/scratch/projects/c2169/Cecilia/CellToCell/code/2_liana/results/robust_all_df.csv")



pdf("2_totalinteractions.pdf")
